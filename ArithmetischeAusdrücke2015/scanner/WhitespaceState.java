...
public class WhitespaceState extends State {
    ...
    public void scan(Character c) {
        this.getMyScanner().skip(); // holt von diesem (this) state den Scanner (jeder State hat einen myScanner), und macht auf diesen Scanner die Methode skip(), d.h. er �berspringt das Zeichen im String (da es in diesem Fall hier halt ein WhiteSpaceState ist, also ein leeres Zeichen)
